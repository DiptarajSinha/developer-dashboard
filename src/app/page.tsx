...
export default function Dashboard() {
  ...
  // --- NEW: FUNCTION TO OPEN GLOBAL SEARCH WITH DATA SYNC ---
  ...
  const REAL_ANALYTICS = [
    ...
    { label: "Total Repositories", value: stats?.totalRepos.toString() || "0", trend: "Public", icon: FolderGit },
  ...
  const HERO_CONTENT = {
    ...
    'tech-lead': {
      ...
      title: latestProject ? `${latestProject.name}` : "System \nStandby",
      ...
      <main className="pl-0 md:pl-20 lg:pl-64 transition-all duration-300">
        ...
        <header className="sticky top-0 z-40 bg-[#141414]/90 backdrop-blur-md border-b border-neutral-800 px-6 py-4 flex justify-between items-center">
           ...
           <div className="hidden md:flex flex-1 max-w-md mx-4">
            ...
            {/* UPDATED SEARCH BUTTON: Uses openGlobalSearch function */}
           ...
           <div className="flex items-center gap-4 ml-auto">
             ...
             <a href="https://github.com/DiptarajSinha" target="_blank" rel="noopener noreferrer" className="relative w-8 h-8 rounded-full overflow-hidden border border-neutral-700 cursor-pointer hover:border-red-500 transition-colors">
              ...
              <img src={`https://github.com/DiptarajSinha.png`} alt="Profile" className="w-full h-full object-cover" title="Logged in as Admin" />
        ...
        <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="h-full flex flex-col">
              ...
              <div className="mt-8 mb-4 h-[32px]"></div>
